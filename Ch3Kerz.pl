...
print <<'EOL';              
 ...
 /________\ --------------------------------------------------/________\                       
   ...
   CFW |========...|             
                ERROR ISTALLING CFU
    Retarthed "CFU" \\ INSTALL COMPLETE           
    Installing NETETTEGETTEM.POL     
    |===========%| 100!     
         |==========%| 100!
  BACKED UP SYSTEM!       
         ....
  ...
  RESTARTING...       
       su$~:Chain+IN.  
         Chain Has ran successfully.  
EOL
print"\n";
print "\t# ==========Ch3Kerz Created By x_john_doe================ \n";
print "\t# You are currently Running OFFICIAL [0.0.1] THank you for running!\n";
print "\t#==========================================================#\n";
print "\t# Ch3Kerz Has started in the background :)! BootStrap downloaded#\n";
print "\t#                 USING CHECKERSBOOT   THANK YOU!                  #\n";
print "\t#################################################################\n";
print "\t##################################################################\n";
print "\n";
...
print "If you dont't know try to find out with the Nmap scanning tool OR a online Tool. \n";
$code=<STDIN>;
chomp($code);
...
print "Sudo-ADMIN~: Target: $site\n";
print "Sudo-ADMIN~: Site source code: $code\n";
